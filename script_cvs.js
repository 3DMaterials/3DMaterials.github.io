...
async function init(){
  ...
  var label_array=[];
    ...
    .then(data => {
      ...
      chart_labels.push(cost);
      bar_colors.push(clr);
      label_array.push(material+'-'+brand+'   '+perim+'/'+infill)
      var trace = {
        x: chart_labels,
        y: chart_val,
        mode: 'markers',
      ...
      var layout = {showlegend: false,
        title: {
          text:'Ultimate Strength vs Cost',
          font: {
      ...
      Plotly.newPlot('myChart_cvs', data,layout);
